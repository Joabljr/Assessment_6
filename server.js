...
var rollbar = new Rollbar({
  accessToken: "15a09bc83a9f4d599e701039b64df74c",
  captureUncaught: true,
  captureUnhandledRejections: true,
});

rollbar.log("My Rollbar Project");
rollbar.log("My Second Attempt");
rollbar.log("Actually My fourth attempt");
rollbar.log("Just Incase");
